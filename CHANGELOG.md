...
- Products view with search and pagination CRUD operations.
- Zustand store for products management.
- MUI DataGrid for products display.
- Devices list view for admins

## [1.11.0] - 2025-11-03

### Added

- Integrate Sentry for remote error tracking.
